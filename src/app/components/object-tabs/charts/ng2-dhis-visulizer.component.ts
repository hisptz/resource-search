...
@Component({
  ...
  templateUrl: `
        <div [ng2-highcharts]="chartData" ng-if="visualizer_config.type == 'chart'"></div>
        <table class="table table-bordered" ng-if="visualizer_config.type == 'table">
            <thead>
